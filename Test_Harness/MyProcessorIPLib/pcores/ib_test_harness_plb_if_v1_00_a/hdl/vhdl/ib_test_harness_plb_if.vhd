------------------------------------------------------------------------------
-- ib_test_harness_plb_if.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          ib_test_harness_plb_if.vhd
-- Version:           1.00.a
...
library ib_test_harness_plb_if_v1_00_a;
use ib_test_harness_plb_if_v1_00_a.user_logic;
...
entity ib_test_harness_plb_if is
  generic
  (
...
end entity ib_test_harness_plb_if;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of ib_test_harness_plb_if is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity ib_test_harness_plb_if_v1_00_a.user_logic
    generic map
    (
